...
func (b *Connect4) SetBoard(board [maxY][maxX]int64) {
	b.board = board
}

func (b *Connect4) SetPlayerMadeBadMove(playerMadeBadMove bool) {
	b.playerMadeBadMove = playerMadeBadMove
}

func (b *Connect4) SetNextPlayerToMove(nextPlayerToMove int64) {
	b.nextPlayerToMove = nextPlayerToMove
}

func (b *Connect4) SetGameOver(gameOver bool) {
	b.gameOver = gameOver
}

func (b *Connect4) SetReward(reward [2]int) {
	b.reward = reward
}
...
func flatten(board [6][7]int) []int {
	return board[0][:cap(board[0])]
}
